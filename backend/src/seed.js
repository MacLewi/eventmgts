...
async function run() {
 ...
 const events = await Event.insertMany([
  ...
  console.log('Seeded events:', events.map(e => ({ title: e.title, status: e.status, price: e.price })));
